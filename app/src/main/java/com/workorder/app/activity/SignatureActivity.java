...
import static com.workorder.app.activity.LoginActivity.jsonObjects;
                    ...
                    if(checkBox.isChecked() && (ch_worker.isChecked() || ch_observer.isChecked()))
                    {
                        if (imageUrl.length()>5500) {
                          ...
                          /*  if (asigneeResponseModel != null) {
                            ...
                            jsonObject.put("UserSignDate",formattedDate);
                            ...
                            if(isConnected ==true) {
                                ...
                                SharedPreferences prefs = context.getSharedPreferences("arraydata", Context.MODE_PRIVATE);
                                SharedPreferences.Editor editor = prefs.edit();
                                Gson gson = new Gson();
                                String json = gson.toJson(jsonObjects);
                                editor.putString("jsonobject", json);
                                editor.apply();
/*
