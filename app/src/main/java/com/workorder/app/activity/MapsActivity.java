...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, TaskLoadedCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        template.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (tv_go_on_site.getText().toString().equalsIgnoreCase("On-Site")) {
                    ...
                    i.putExtra("workorderid", assesmentHomePOJO.getWorkOrderNumber());
                    startActivity(i);
                } else {
        ...
        assesmentHomePOJO = (WorkOrderPOJO) getIntent().getSerializableExtra("WorkOrderPOJO");
        Log.v("assid", String.valueOf(assesmentHomePOJO.getAssessmentTaskId()));
        Log.v("assid", String.valueOf(assesmentHomePOJO.getAssessmentId()));
            ...
            public void onClick(View v) {
                ...
                if (distance <= DISTANCE) {
                    ...
                    if (tv_go_on_site.getText().toString().equalsIgnoreCase("Off-Site")) {
                        ...
                        prefsEditor.putInt("assess",assesmentHomePOJO.getAssessmentTaskId() );
                        prefsEditor.commit();
    ...
    public void callCreateActivity(String status) {
        ...
        if (UtilityFunction.isNetworkAvailable(this)) {
            ...
            try {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://109.228.49.117:8095/api/SiteActivity/createactivity", new Response.Listener<String>() {
                    @Override
    ...
    public void callApi() {
        try {
            ...
            if (assesmentHomePOJO != null) {
                ...
                description.setText(assesmentHomePOJO.getDescription());
