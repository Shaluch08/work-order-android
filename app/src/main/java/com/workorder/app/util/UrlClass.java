...
public class UrlClass {
    ...
    public static String CHECK_ON_SITE_URL=BASE_URL+"api/SiteActivity/getactivity?Id=";//"taskapi/Activity/";
...
//http://109.228.49.117:8095/api/order/assignedorderlist?rolename=\(userRole)&companyid=\(companyID)
    ...
    public static String UPLOAD_SIGN_URL=BASE_URL+"api/TaskApi/SignedDocument"; //"TaskApi/SignedDocument";

    public static String GET_WORK_ORDER_NO=BASE_URL+"api/workorderfortenant/getworkordernumber";

    public static String UPDATE_STATUS_URL=BASE_URL+ "api/SiteActivity/updateactivity";//"SiteActivity/updatestatus";
